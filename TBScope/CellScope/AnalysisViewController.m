...
- (void)analyzeField:(int)fieldNumber
{
    ...
    Images* currentImage = (Images*)[[[self.currentSlide slideImages] allObjects] objectAtIndex:fieldNumber];
...
- (void)analysisCompleteCallback
{
    ...
    else
    {
        ...
        for (im in [[self.currentSlide slideImages] allObjects])
        {
            [allROIs addObjectsFromArray:[im.imageAnalysisResults.imageROIs allObjects]];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if([segue.identifier isEqualToString:@"ResultsSegue"]) {
        ...
        rtbc.currentSlide = self.currentSlide;
